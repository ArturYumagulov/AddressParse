...
class ProductCenterParser:
    ...
    def get_points(self):
        ...
        for card in firms:
            # "https://productcenter.ru/producers/2084/kompaniia-berion-socks"
            ...
            print(phone, address, email, inn, legal_name, name, point_coordinates)
            time.sleep(3)
...
if __name__ == '__main__':
    x = ProductCenterParser("samarskaia-obl-205")
    x.get_points()
